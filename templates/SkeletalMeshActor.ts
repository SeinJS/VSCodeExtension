...
export interface I__class__Options extends Sein.ISkeletalMeshComponentState {
...
export default class __class__ extends Sein.SkeletalMeshActor<I__class__Options> {
