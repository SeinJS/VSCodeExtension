...
export interface I__class__Options extends Sein.ISceneComponentState {
...
export default class __class__ extends Sein.SceneActor<I__class__Options, Sein.SceneComponent> {
